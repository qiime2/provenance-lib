...
def build_header(shebang: str = '', boundary: str = '',
    ...
    header.extend([
        ...
        "",
        "# This document is a representation of the scholarly work of the "
        "original",
        "# author and may be protected by intellectual property law. Please "
        "respect any",
        "# copyright restrictions and licenses governing the use, modification"
        ", or",
