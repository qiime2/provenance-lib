...
from .util import get_root_uuid, UUID
...
class ParserResults():
    ...
    """
    # TODO: This should become parsed_artifact_uids or similar: Set[UUID]
    root_md: '_ResultMetadata'
    archive_contents: nx.DiGraph
...
class Parser(metaclass=abc.ABCMeta):
    ...
    def can_handle(data):
        """
        Return True if this Parser can handle the data passed to this method
        """
        raise NotImplementedError

    @abc.abstractmethod
    def parse_prov(cls, cfg: Config, data):
        """
        Parse provenance
